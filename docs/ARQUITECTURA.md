...
src/
  ...
  app/
    ...
    shared/ui/
      ...
      ineb-logo/             app-ineb-logo: marca INEB en SVG, autocontenida (no depende de
                             nada de la app: se copia la carpeta y funciona). Tres formas
                             (completa, compacta, isotipo), dos tonos, una tinta y cuadro
                             para favicon. README.md = hoja de marca completa: retícula,
                             medidas exactas, paleta, mínimos, espacio de respeto, usos
                             prohibidos y cómo reproducirla fuera de Angular (+ .dom.spec.ts)
