...
export const SCHEDULE_DATA: ScheduleEntry[] = [
  ...
  { team: 'Echipa 1', coordinator: 'Halas Luigi',     programType: 'Seară de tineret', estimatedPersons: 45, date: new Date(2026, 5, 5),  observations: '', completed: false, parentSupporters: ['p-001']},
  { team: 'Echipa 2', coordinator: 'Dobre David',     programType: 'Seară de tineret', estimatedPersons: 45, date: new Date(2026, 5, 12),   observations: '', completed: false, parentSupporters: ['p-003'] },
  ...
  { team: 'Echipa 4', coordinator: 'Mic Karina',      programType: 'Seară de tineret', estimatedPersons: 45, date: new Date(2026, 5, 26),  observations: '', completed: false, parentSupporters: ['p-002', 'p-012']},
  { team: 'Echipa 5', coordinator: 'Toader Noemi',    programType: 'Seară de tineret', estimatedPersons: 45, date: new Date(2026, 6, 3),   observations: '', completed: false, parentSupporters: ['p-005', 'p-013'] },
  { team: 'Echipa 6', coordinator: 'Halas Noemi',     programType: 'Seară de tineret', estimatedPersons: 45, date: new Date(2026, 6, 10),  observations: '', completed: false, parentSupporters: ['p-004', 'p-009'] },
  { team: 'Echipa 7', coordinator: 'Bereza Ionatan',  programType: 'Seară de tineret', estimatedPersons: 45, date: new Date(2026, 6, 17),  observations: '', completed: false, parentSupporters: ['p-007', 'p-010'] },
  { team: 'Echipa 1', coordinator: 'Halas Luigi',     programType: 'Seară de tineret', estimatedPersons: 45, date: new Date(2026, 6, 24),  observations: '', completed: false, parentSupporters: ['p-008', 'p-003'] },
  { team: 'Echipa 2', coordinator: 'Dobre David',     programType: 'Seară de tineret', estimatedPersons: 45, date: new Date(2026, 6, 31),  observations: '', completed: false, parentSupporters: ['p-001', 'p-002'] },
  // falta 2 - 3 - 6
];
